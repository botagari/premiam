...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['Knights','Bots server'];
    var i = -1;
    var j = 0;
...
client.on('message', msg -> {
	if (msg.content === 'الشعار') {
		msg.reply('**[ ! KD, ] : شعارك بالديسكورد [ !ᵏᵈを ] :شعارك باللعبه**') ;
	}
});
...
client.on('message', msg -> {
	if (msg.content === 'الرابط') {
		msg.reply('**https://discord.gg/kFAzFHj**') ;
	}
});
...
client.on('message', msg -> {
	if (msg.content === '!') {
		msg.reply('**- Welcome To Knights Of Darkness :champagne_glass: :fallen_leaf: -**') ;
	}
});
...
client.on('message', msg -> {
	if (msg.content === '..') {
		msg.reply('**خلآص , يعم ترأ تعبت منك ,, **') ;
	}
});
...
client.on('message', msg -> {
	if (msg.content === '.') {
		msg.reply('**آطٌلَقَ مِنٌ يّنٌقَطٌ, وللكم , ء منور**') ;
	}
});
...
client.on('message', msg -> {
	if (msg.content === 'برب') {
		msg.reply('**, :wink: :eight_pointed_black_star:تيت الله معك يحلو لا تطول علينا :eight_pointed_black_star: :wink:.!**') ;
	}
});
...
client.on('message', msg -> {
	if (msg.content === 'باك') {
		msg.reply('**ولـكم ء , آطلق من جآنا**') ;
	}
});
...
client.on('message', msg -> {
	if (msg.content === 'السلام عليكم') {
		msg.reply('**وعليكم السلام ورحمة الله وبركاته ,منور ء**') ;
	}
});
